...
FROM (SELECT p.pro_id,
      ...
      FROM tbl_pro p
               ...
               JOIN tbl_user u ON p.user_id = u.user_id) p1
...
SELECT *
FROM (SELECT ROWNUM AS RN, request.*
      FROM (SELECT PRO_REQUEST_ID,
                   PRO_REQUEST_PAY,
                   PRO_REQUEST_DATE,
                   PRO_REQUEST_PROGRESS,
                   NVL(PR.PRO_STAR_RATE, '0') AS pro_Star_Rate,
                   PR.PRO_NAME,
                   PR.EMP_CNT,
            ...
            ORDER BY PRO_REQUEST_DATE DESC) request
      WHERE rownum <= 6)
WHERE rn > 0;
...
values (SEQ_UPLOAD.nextval, '요렇게도 한번 해봐요 우리', 'ㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹ', 20000, 5000,
        sysdate, 4, 24);
insert into TBL_PRO_UPLOAD (PRO_UPLOAD_ID, PRO_UPLOAD_TITLE, PRO_UPLOAD_CONTENT, PRO_UPLOAD_PAY, PRO_UPLOAD_PAY_RANGE,
                            PRO_UPLOAD_DATE, PRO_ID, SERVICE_ID)
values (SEQ_UPLOAD.nextval, '여기 여행지도 좋아요요!!!', 'ㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹ', 20000,
        5000, sysdate, 3, 34);
...
ORDER BY USER_UPLOAD_DATE DESC;
...
alter table TBL_CARDINFO_FILE
    drop column CARDINFO_FILE_SAVED;

alter table TBL_COMMUNITY_FILE
    drop column COMMUNITY_FILE_SAVED;

alter table TBL_PRO_UPLOAD_FILE
    drop column PRO_UPLOAD_FILE_SAVED;

alter table TBL_USER_UPLOAD_FILE
    drop column USER_UPLOAD_FILE_SAVED;
